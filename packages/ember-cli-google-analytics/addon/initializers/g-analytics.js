...
export function initialize(app) {
  ...
  if (analytics.version === 'v4') {
    if (app.inject) {
      ...
      console.warn ('auto-injection is deprecated in Ember 5. Please manually inject @service gtag into your Ember objects.');
    }
  } else {
    if (app.inject) {
      deprecate(
      ...
      console.warn ('auto-injection is deprecated in Ember 5. Please manually inject @service gAnalytics into your Ember objects.');
    }
  }
}
